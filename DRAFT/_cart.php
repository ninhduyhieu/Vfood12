	...
	<div class="content-center main-body">
		...
		<?php
			...
			while ($row = mysqli_fetch_assoc($result)) {
				...
				echo "<td>".$row["name"]."</td>";
				echo "<td style='text-align: center'><img width='50' height='50' src='img/".$row["image"]."' alt='Lỗi hiển thị ảnh'></td>";
				...
				echo "<td>".formatCurrency($row["gia_moi"])."</td>";
				$totalBill += ($arrCart[$row["MaSP"]] * $row["gia_moi"]);
				echo "<td>".formatCurrency($arrCart[$row["MaSP"]] * $row["gia_moi"])."</td>";
				echo "<td style='width: 50px; text-align: center;'><a href='shopping_remove.php?prdid=".$row["MaSP"]."'><img src='public/images/ic_delete.png' alt='Xóa'></a></td>";
				echo "</tr>";
			}
