...
<body>
            ...
            <div class="col-lg-6 text-center text-lg-right">
                <div class="d-inline-flex align-items-center">
                    ...
                    <a class="text-dark px-2"
                        href="https://open.spotify.com/user/31i6aw3jtq3hs64clw7abjbgdr4i?si=b4af6a788b294192">
        ...
        <div class="row px-xl-5 pb-3">
            <div class="col-lg-4 col-md-6 pb-1">
                <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                    ...
                    <a href="shop.php?MaDM=1" class="cat-img position-relative overflow-hidden mb-3">
            ...
            <div class="col-lg-4 col-md-6 pb-1">
                <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                    <p class="text-right"></p>
                    <a href="shop.php?MaDM=2" class="cat-img position-relative overflow-hidden mb-3">
            ...
            <div class="col-lg-4 col-md-6 pb-1">
                <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                    <p class="text-right"></p>
                    <a href="shop.php?MaDM=3" class="cat-img position-relative overflow-hidden mb-3">
                        <img class="img-fluid w-100" src="img/cat-3.jpg" alt="">
                    </a>
            ...
            <div class="col-lg-4 col-md-6 pb-1">
                <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                    <p class="text-right"></p>
                    <a href="shop.php?MaDM=4" class="cat-img position-relative overflow-hidden mb-3">
                        <img class="img-fluid w-100" src="img/cat-4.jpg" alt="">
                    </a>
            ...
            <div class="col-lg-4 col-md-6 pb-1">
                <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                    <p class="text-right"></p>
                    <a href="shop.php?MaDM=5" class="cat-img position-relative overflow-hidden mb-3">
                        <img class="img-fluid w-100" src="img/cat-5.jpg" alt="">
                    </a>
            ...
            <div class="col-lg-4 col-md-6 pb-1">
                <div class="cat-item d-flex flex-column border mb-4" style="padding: 30px;">
                    <p class="text-right"></p>
                    <a href="shop.php?MaDM=6" class="cat-img position-relative overflow-hidden mb-3">
                        <img class="img-fluid w-100" src="img/cat-6.jpg" alt="">
                    </a>
            ...
            <div class="col-md-6 pb-4">
                <div class="position-relative bg-secondary text-center text-md-right text-white mb-2 py-5 px-5">
                    ...
                    <div class="position-relative" style="z-index: 1;">
                        ...
                        <h1 class="mb-4 font-weight-semi-bold"> Collection</h1>
    ...
    <div class="container-fluid pt-5">
        <div class="text-center mb-4">
            <h2 class="section-title px-5"><span class="px-2">Trandy</span></h2>
        </div>
        <div class="row px-xl-5 pb-3">
            <?php
    ...
    <div class="container-fluid pt-5">
        ...
        <div class="row px-xl-5 pb-3">
            <?php
            $sql = "SELECT * FROM san_pham ORDER BY MaSP DESC LIMIT 4";
            $result = mysqli_query($conn, $sql);
            while ($row = $result->fetch_assoc()) {
                echo " 
            <div class=\"col-lg-3 col-md-6 col-sm-12 pb-1\">
